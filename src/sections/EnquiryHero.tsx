...
export default function EnquiryHero() {
  return (
    <section 
      ...
      style={{ backgroundImage: "url('https://dubaifintechsummit.com/wp-content/uploads/2026/03/News-and-Events-Banner-Desktop-scaled.webp')" }}
    >
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10 w-full text-center flex flex-col items-center justify-center pt-16">
        <motion.h1 
          ...
          className="text-4xl md:text-5xl font-black tracking-tight leading-tight enquiry-hero-title"
        >
          General Enquiry
        </motion.h1>
      </div>
