...
export default function SpeakersHero() {
  return (
    ...
    >
      ...
      {/* Explicit style override to bypass global light theme overrides */}
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 w-full text-center flex flex-col items-center justify-center pt-16">
        {/* Heading */}
        <motion.h1
          initial={{ opacity: 0, y: 15 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
          className="text-4xl md:text-5xl font-black tracking-tight leading-tight hero-title-white"
        >
          Speakers Lineup
        </motion.h1>
      </div>
